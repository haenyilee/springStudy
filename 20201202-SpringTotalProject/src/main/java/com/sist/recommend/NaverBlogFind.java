...
public class NaverBlogFind {
	 public void naverFindData(String data) {
	     	String clientId = "X4Y7VGU2Y0hzDpSLNTKS"; //애플리케이션 클라이언트 아이디값"
	     	String clientSecret = "rWfdiPwNHD"; //애플리케이션 클라이언트 시크릿값"
	        ...
	        {
	        	// xml 내용 파일로 저장
	        	FileWriter fw=new FileWriter("c:\\upload\\recommend.xml");
